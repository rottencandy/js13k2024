...
export const MAX_BULLET_AGE = 3000
...
export const INIT_FIRE_RATE_MS = 2e3
export const INIT_BULLET_SPEED = 0.5
export const INIT_BULLET_DMG = 10
export const INIT_SPAWN_RATE = 1e3
export const INIT_PICKUP_RADIUS = 200
